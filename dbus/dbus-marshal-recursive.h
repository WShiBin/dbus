...
struct DBusTypeWriter {
    ...
    dbus_uint32_t
        type_pos_is_expectation : 1; /**< type_pos can be either an insertion point for or an expected next type */
...
DBUS_PRIVATE_EXPORT
void _dbus_type_reader_recurse(DBusTypeReader* reader, DBusTypeReader* subreader);
DBUS_PRIVATE_EXPORT
