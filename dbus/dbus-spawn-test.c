...
static dbus_bool_t check_spawn_nonexistent(void* data) {
    ...
    if (_dbus_spawn_async_with_babysitter(
            &sitter, "spawn_nonexistent", (char* const*)argv, NULL, DBUS_SPAWN_NONE, NULL, NULL, &error)) {
...
static dbus_bool_t check_spawn_segfault(void* data) {
...
static dbus_bool_t check_spawn_exit(void* data) {
    char*           argv[4] = {NULL, NULL, NULL, NULL};
    DBusBabysitter* sitter  = NULL;
    DBusError       error   = DBUS_ERROR_INIT;
    DBusString      argv0;
...
static dbus_bool_t check_spawn_and_kill(void* data) {
    char*           argv[4] = {NULL, NULL, NULL, NULL};
    DBusBabysitter* sitter  = NULL;
    DBusError       error   = DBUS_ERROR_INIT;
    DBusString      argv0;
