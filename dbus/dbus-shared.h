...
typedef enum {
    ...
    DBUS_HANDLER_RESULT_NEED_MEMORY      /**< Need more memory in order to return #DBUS_HANDLER_RESULT_HANDLED or
                                            #DBUS_HANDLER_RESULT_NOT_YET_HANDLED. Please try again later with more memory. */
} DBusHandlerResult;
...
#define DBUS_REQUEST_NAME_REPLY_IN_QUEUE \
    2 /**< Service could not become the primary owner and has been placed in the queue */
